...
EXPERIMENT_NAME = "Shallow-To-Deep"
...
FULL_DATA_FOLDERS = [
    ...
    #r"/data/datasets/SR_Dataset_v1/test_L_files"]

# How many layer thicknesses to predict.
LAYER_PREDICT_COUNT = 15
# How many "feature layers" to use.
LAYER_FEATURE_COUNT = 5
    ...
    for mat_file_name in tqdm(mat_file_list):
        ...
        for layer in range(LAYER_FEATURE_COUNT):
            ...
            for x in range(NODE_COUNT):
                ...
                #print("Mean lat:", np.mean(lat), "Mean long:", np.mean(long))
